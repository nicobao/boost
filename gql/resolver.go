...
func (r *resolver) dealByPieceCID(ctx context.Context, pieceCid, publishCid *cid.Cid) (*types.ProviderDealState, error) {
	deal, err := r.dealsDB.ByPieceCID(ctx, pieceCid.String(), publishCid.String())
	if err != nil {
		return nil, err
	}
